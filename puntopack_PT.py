...
baseurl = 'https://www.mondialrelay.be/api/parcelshop?country=PT&postcode='
...
jsonFile = open("C:\WS\puntopack\puntopack_PT_data.json", "w")
jsonFile.write(pp_str)
jsonFile.close()

pp = pd.read_json("C:\WS\puntopack\puntopack_PT_data.json")

#Georef
gdf = gpd.GeoDataFrame(df, geometry=gpd.points_from_xy(df.Longitude, df.Latitude))

gdf.to_file("C:\WS\puntopack\puntopack_PT.geojson", driver="GeoJSON")
