...
baseurl = 'https://www.puntopack.es/api/parcelshop?country=NL&postcode='
...
jsonFile = open("C:\WS\puntopack\puntopack_NL_data.json", "w")
jsonFile.write(pp_str)
jsonFile.close()

pp = pd.read_json("C:\WS\puntopack\puntopack_NL_data.json")

#Georef
gdf = gpd.GeoDataFrame(df, geometry=gpd.points_from_xy(df.Longitude, df.Latitude))

gdf.to_file("C:\WS\puntopack\puntopack_NL.geojson", driver="GeoJSON")
