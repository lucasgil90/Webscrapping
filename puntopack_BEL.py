...
baseurl = "https://www.mondialrelay.be/api/parcelshop?country=FR&postcode="         
...
jsonFile = open("C:\WS\puntopack\puntopack_BE_data.json", "w")
jsonFile.write(pp_str)
jsonFile.close()


pp = pd.read_json("C:\WS\puntopack\puntopack_BE_data.json")
#Georef
